...
class RecipeImageUploadTests(TestCase):
    ...
    def test_filter_recipe_by_tag(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Papas arrugadas con mojo')
        recipe2 = sample_recipe(user=self.user, title='Aubergine with tahini')
        tag1 = sample_tag(user=self.user, name='Regional')
    ...
    def test_filter_recipe_by_ingredient(self):
        ...
        recipe1 = sample_recipe(user=self.user, title='Papas arrugadas con mojo')
        recipe2 = sample_recipe(user=self.user, title='Aubergine with tahini')
        ingredient1 = sample_ingredient(user=self.user, name='Papas')
